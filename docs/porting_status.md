...
| `bhmie.py` | Bohren-Huffman Mie scattering | No (numpy) | 37 |
| `radiative_forcing.py` | Direct SW RF (Chylek & Wong 1995) | Partial | 37 |
...
- **341 tests** across 16 test files (677 pass, 350 skip needing Fortran data)
...
| `bhmie.py` to JAX port | LOW | 3-5 days | Mie scattering currently numpy-only, blocks RF JIT |
